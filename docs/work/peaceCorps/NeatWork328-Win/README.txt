...
This program is developped by the NGO APLV (Agua Para La Vida) and
Logilab (University of Geneva). Mosek Solver is graciously made
available for the optimisation part of the software.
...
mosek2_1.dll	: Solver libraries
solver.dll      : Solver libraries
pthreadvse.dll  : Solver libraries

--> Leave these files in the main directory.

2. Java Requirements --------------------

NeatWorks needs the Java Virtual Machine 1.4 or above. (A older version
can be used if you have Xerces in your CLASSPATH). This restriction
...
First : Try todouble-click on the JAR file.
...
4. Edit network data with a spreadsheet --------------------------
...
the spreadsheed to NeatWork can be performed by simple cut and paste.
...
- Type d'orifice commercial par défaut.Garder en mémoire les paramètres de New Simulation (DONE)
